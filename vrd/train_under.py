...
classes_1 = set(['/m/0bt9lr', '/m/01yrx'])
classes_2 = set(['/m/04bcr3', '/m/01y9k5', '/m/01mzpv', '/m/0cvnqh', '/m/078n6m', '/m/0k4j'])

classes = set([
    '/m/0bt9lr,/m/04bcr3', '/m/0bt9lr,/m/01y9k5', '/m/01yrx,/m/01mzpv',
    '/m/0bt9lr,/m/01mzpv', '/m/0bt9lr,/m/0cvnqh', '/m/01yrx,/m/04bcr3',
    '/m/0bt9lr,/m/078n6m', '/m/01yrx,/m/0k4j'])
...
def create_train_data(args):
    ...
    print('num under images:', len(df_vrd.loc[df_vrd.RelationshipLabel=='under'].ImageID.unique()))
...
def get_train_data(args):
    ...
    df_neg = shuffle(pd.read_csv(args.neg_sample_fn)).iloc[:100].copy()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--generate', type=str, default='under/df_neg.csv')
    parser.add_argument('--train', action='store_true')
    parser.add_argument('--neg_sample_fn', type=str, default=None)
    parser.add_argument('--model_file', type=str, default='under/cat.model')
