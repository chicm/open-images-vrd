...
classes_1 = set(['/m/04yx4', '/m/0bt9lr', '/m/01bl7v', '/m/05r655', '/m/03bt1vf', '/m/01yrx'])
classes_2 = set(['/m/0k4j', '/m/0pg52', '/m/0h2r6', '/m/01s55n', '/m/01940j', '/m/080hkjn'])

classes = set([
    '/m/04yx4,/m/0k4j', '/m/0bt9lr,/m/0k4j', '/m/04yx4,/m/0pg52',
    ...
    '/m/01yrx,/m/080hkjn', '/m/01bl7v,/m/0pg52'])
...
def create_train_data(args):
    ...
    df_pos = df_vrd.loc[df_vrd.RelationshipLabel=='inside_of'].copy()
    ...
    print('num inside_of_rel images:', len(df_vrd.loc[df_vrd.RelationshipLabel=='inside_of'].ImageID.unique()))
...
def get_train_data(args):
    ...
    df_neg = shuffle(pd.read_csv(args.neg_sample_fn)).iloc[:5000].copy()
