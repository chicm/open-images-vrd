...
classes_1 = set(['/m/01mzpv', '/m/03bt1vf', '/m/04yx4', '/m/05r655', '/m/01bl7v'])
classes_2 = set(['/m/01y9k5', '/m/04bcr3', '/m/078n6m'])
...
def create_train_data(args):
    ...
    df_pos = df_vrd.loc[df_vrd.RelationshipLabel=='at'].copy()
    ...
    print('num plays images:', len(df_vrd.loc[df_vrd.RelationshipLabel=='at'].ImageID.unique()))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--generate', type=str, default='at/df_neg.csv')
    parser.add_argument('--train', action='store_true')
    parser.add_argument('--neg_sample_fn', type=str, default=None)
    parser.add_argument('--model_file', type=str, default='at/cat.model')
